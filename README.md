...
- 自定义工作时长、休息时长和番茄钟轮数。
- 番茄钟开始后进入全屏专注界面，Android 会优先使用屏幕固定/Lock Task 降低手势退出绕过风险。
- 休息和工作期临时退出遵循 3 次机会规则，计时始终按真实时间推进。
- 设置、权限和更新入口收纳进左上角折叠菜单，让主界面保持简洁。
- Android 上请求勿扰模式权限，屏蔽普通通知并保留电话。
- Android 首次运行会集中检测电话、通知和勿扰相关权限，后续不再自动反复询问。
